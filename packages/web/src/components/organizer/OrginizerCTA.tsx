...
const benefits = [
  ...
  },
  {
    ...
    description: 'Manage vendors and stakeholders easily with our platform ',
    highlight: 'Streamline event operations and communication ',
  },
  {
    icon: (
  ...
  },
  {
    ...
    description: 'NFC wristbands for secure payments and access control',
    highlight: 'Eliminate cash handling and streamline entry',
  },
];
...
const OrganizerCTA = () => {
  ...
  return (
    <section
      ref={ref}
      className="relative py-28 bg-gradient-to-b from-gray-50 to-white dark:from-gray-950 dark:to-gray-900 overflow-hidden"
      id="for-organizers"
    >
      {/* Floating elements */}
