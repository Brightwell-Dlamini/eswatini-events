...
const Categories_landing = ({
  ...
  return (
    <>
      <section className="relative bg-white dark:bg-gray-900 py-8 md:py-12 border-b border-gray-100 dark:border-gray-800">
        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10 py-10">
          ...
          >
            ...
            >
              Discover events that match your vibe and
...
export default Categories_landing;
